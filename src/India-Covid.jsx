...
const IndiaCovid = () =>{
    ...
    return (
        <>
            <h1 className="heading" style={{textAlign:'center',width:'122vh'}}> <AcUnitIcon className="rotate" /><span className="india-1"> IN</span><span className="india-2">D</span><span className="india-3">IA</span> COVID19<i class="fas fa-disease"></i>STATEWISE STATUS <AcUnitIcon className="rotate" /></h1>
            <div>
